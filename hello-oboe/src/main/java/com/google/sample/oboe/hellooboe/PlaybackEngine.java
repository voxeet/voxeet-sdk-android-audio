...
public class PlaybackEngine {
    ...
    static boolean getToneOn(){
        if (mEngineHandle == 0) return false;
        return native_getToneOn(mEngineHandle);
    }
    ...
    private static native boolean native_getToneOn(long engineHandle);
